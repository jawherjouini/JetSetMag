...
public class GraphReaderExample {
    ...
    public void runEverything() throws SQLException, ClassNotFoundException, UnsupportedEncodingException, MessagingException {
        fetchObject();
    }

    void fetchObject() throws SQLException, ClassNotFoundException, UnsupportedEncodingException, MessagingException {
        ...
        mdao.AjouterMembre(user.getName().toString(), user.getUsername().toString(), user.getEmail().toString());
