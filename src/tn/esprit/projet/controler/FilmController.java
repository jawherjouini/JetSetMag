 ...
 * @author tasnim
 */
public class FilmController implements Initializable,ControlledScreen {
    ScreensController screencontroller;
    @FXML
    private AnchorPane MyPane;

    static  final  double WIDTH = 900, HEIGHT= 400;
    @FXML
    private Pane imagepane;
        private static VBox PaneDesc;
    @FXML
...
//        for (int i = 0; i < 14; i++) {
//            images[i] = new Image( FilmController.class.getResource("animal"+(i+1)+".jpg").toExternalForm(),false);
//        }
        
          
        List<String> result = r.getImages("http://rss.allocine.fr/ac/cine/cettesemaine?=xml");//http://www.premiere.fr/var/premiere/storage/rss/cinema_actu.xml");//http://www.premiere.fr/var/premiere/storage/rss/live_actu.xml");//http://rss.allocine.fr/ac/bandesannonces/anepasmanquer?format=xml");//http://rss.allocine.fr/ac/bandesannonces/anepasmanquer?format=xml");
        //int i = 0;
         //List<String> item = r.getItems("http://www.premiere.fr/var/premiere/storage/rss/live_actu.xml");
        
         for (int j = 0; j < result.size(); j++) {
            String string = result.get(j);
            //System.out.println(string+"\n");
            images.add(new Image(string.trim() ,false));
           // String desc = item.get(j);
            //System.out.println(string+"\n");
            //Label lb = new Label(desc);
//            lb.setOpacity(1);
//            lb.setStyle("color : black;");
//            myVbox.setStyle("background-color:#ffffff;");
//            myVbox.getChildren().add(lb);
//          
        }
...
//            System.out.println(string+"\n");
//            images[i] = new Image("http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/medias/nmedia/18/79/64/78/19221019_fa1.jpg" ,false);
//            System.out.println(string+" "+i+"\n");
//            i++;
////            
//        }
//        images[0]=new Image("http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/medias/nmedia/18/79/64/78/19221019_fa1.jpg",false);
//        images[1]=new Image("http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/medias/nmedia/18/79/64/78/19221019_fa1.jpg",false);
//        images[2]=new Image("http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/medias/nmedia/18/79/64/78/19221019_fa1.jpg",false);
//        images[3]=new Image("http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/medias/nmedia/18/79/64/78/19221019_fa1.jpg",false);
//        images[4]=new Image("http://a69.g.akamai.net/n/69/10688/v1/img5.allocine.fr/acmedia/medias/nmedia/18/79/64/78/19221019_fa1.jpg",false);
//        // create display shelf
       // images[0]= new Image(null, 100, 100, false, false);
        Shelf displayShelf = new Shelf(images);
        
       MyPane.setStyle("-fx-background-color: linear-gradient(to bottom," +
                    " black 60, #141414 60.1%, black 100%);");
        displayShelf.setPrefSize(WIDTH, HEIGHT);
        imagepane.getChildren().add(displayShelf);
        //MyPane.getChildren().add(imagepane);
...
//                    " black 60, #141414 60.1%, black 100%);");
            ...
            final List<String> TabDesc = r.getItems("http://rss.allocine.fr/ac/cine/cettesemaine?=xml");//http://www.premiere.fr/var/premiere/storage/rss/cinema_actu.xml");//http://www.premiere.fr/var/premiere/storage/rss/live_actu.xml");
            ...
            for (int i=0; i<images.size(); i++) {
                ...
                item.setOnMouseClicked(new EventHandler<MouseEvent>() {
                    public void handle(MouseEvent me) {
                        ...
                        lb.setText(TabDesc.get((int)scrollBar.getValue()));
                        //lb.setOpacity(1);
                        //myVbox.setStyle("background-color:#ffffff;");                    
                        myVbox.getChildren().removeAll(lb);
                        lb.setText("");
                        myVbox.getChildren().add(lb);
