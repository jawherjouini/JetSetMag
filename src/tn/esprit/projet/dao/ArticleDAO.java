...
public class ArticleDAO {
    ...
    public ObservableList<Article> ListerArticlesParOrdre(String ordre) {
        Statement stmt;
        ObservableList<Article> result = null;
        Connection cnx;
        ResultSet rs;
        try {
            result = FXCollections.observableArrayList();
            cnx = Connexion.getInstance();
            String query = "Select * from article order by "+ordre+" desc";
            stmt = cnx.createStatement();
            rs = stmt.executeQuery(query);
            while (rs.next()) {
                Article a = new Article();
    ...
    public boolean update(Article a) {
        ...
        try {
            ...
            String query = "update article set titre='"+titre+"', texte= '"+texte+"', note_moy="+a.getNote_moy()+" where id_article="+id;
